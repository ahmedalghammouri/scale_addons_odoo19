...
class WeighingWeighPoint(models.Model):
    _name = 'weighing.weighpoint'
    _description = 'Weigh Point Session'
    ...
    weighing_ids = fields.One2many('truck.weighing', 'weighpoint_session_id', string='Weighings')
...
class TruckWeighing(models.Model):
    ...
    weighpoint_session_id = fields.Many2one('weighing.weighpoint', string='Weigh Point Session', ondelete='set null')
